...
const initialStudents: Student[] = [
  { id: 1, tenantId: 1, name: "Emma Johnson", studentId: "STU-001", cardStatus: "Active", cardHardwareId: "E214D03D", cardType: "NFC", walletBalance: 45.50, dailyLimit: 10, monthlyLimit: 150, pin: "1234", parentNotificationSent: true, className: "Year 9B", homeAddress: "5 Elm Road, London", billingAddress: "5 Elm Road, London", parentName: "Helen Johnson", parentEmail: "helen@family.com", imageUrl: "https://api.dicebear.com/7.x/initials/svg?seed=Emma Johnson", cardLifecycleStatus: 'activated', activatedAt: '2026-06-02' },
